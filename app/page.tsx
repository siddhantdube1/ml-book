...
const parts: { title: string; chapters: Chapter[] }[] = [
  ...
  },
  {
    ...
    chapters: [
      ...
      { num: 6, title: 'Gradient descent', blurb: 'The optimisation engine behind nearly every modern model.' },
      { num: 7, title: 'Logistic regression', blurb: 'From regression to classification with one elegant change of perspective.' },
  ...
  },
  {
    ...
    chapters: [
      { num: 12, title: 'Decision trees', blurb: 'Splitting, growing, pruning — and watching it all happen.' },
      { num: 13, title: 'Random forests', blurb: 'Why a crowd of imperfect trees beats one perfect one.' },
