...
const parts: { title: string; chapters: Chapter[] }[] = [
  {
    ...
    chapters: [
      ...
      { num: 4, title: 'Your first model: k-nearest neighbours', blurb: 'Building intuition for prediction without writing a single equation.', href: '/chapters/4-k-nearest-neighbours' },
    ],
  },
  {
    title: 'II — Linear models',
    chapters: [
      { num: 5, title: 'Linear regression', blurb: 'The mother of all models. Closed form, gradient descent, and what they reveal.', href: '/chapters/5-linear-regression' },
  ...
  },
  {
    ...
    chapters: [
      ...
      { num: 16, title: 'Naive Bayes', blurb: 'Probability done plainly. A surprisingly strong baseline.', href: '/chapters/16-naive-bayes' },
      { num: 17, title: 'Feature engineering', blurb: 'The unglamorous work that decides whether anything else matters.', href: '/chapters/17-feature-engineering' },
    ],
  },
  {
  ...
  },
  {
    ...
    chapters: [
      ...
      { num: 22, title: 'Backpropagation and training', blurb: 'How a network learns, derived from first principles.', href: '/chapters/22-backpropagation-and-training' },
    ],
  },
]
